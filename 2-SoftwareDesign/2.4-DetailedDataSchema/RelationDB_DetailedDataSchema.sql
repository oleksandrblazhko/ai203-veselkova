...
CREATE TABLE Users ( -- опис співробітників
	...
	dancer_id NUMBER(10), -- N танцора
	choreographer_id NUMBER(10), -- N хореографа 
);
...
ALTER TABLE Users ADD CONSTRAINT us_dancer_id_fk
	FOREIGN KEY (dancer_id)
	REFERENCES Dancers (dancer_id);
	
ALTER TABLE Users ADD CONSTRAINT us_choreographer_id_fk
...
-- обмеження зовнішніх ключів
ALTER TABLE Dancers ADD CONSTRAINT us_dancer_id_fk
